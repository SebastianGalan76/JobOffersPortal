package com.coresaken.jobportal.auth.service;
...
import com.coresaken.jobportal.database.repository.ResetPasswordTokenRepository;
...
import com.coresaken.jobportal.service.async.AsyncAccountService;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse signUp(SignUpRequestDto request, HttpServletResponse response) {
        ...
        userDetail.setCreatedAt(currentDate);
        userDetail.setLastLogin(currentDate);
